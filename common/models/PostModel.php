 ...
 * @property string $label_img_small 缩略图
...
class PostModel extends BaseModel
{
    ...
    public function rules()
    {
        return [
            ...
            [['title', 'summary', 'label_img','label_img_small', 'user_name'], 'string', 'max' => 255],
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'content' => '内容',
            'label_img' => '表情图',
            'label_img_small' => 'Label img_small',
            'cat_id' => '分类',
            'user_id' => '用户ID',
            'user_name' => '用户名',
            'is_valid' => '状态',
